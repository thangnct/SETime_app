...
export default class TaskList extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            goalList: [
                { id: 1, goalTitle: "Get Link", status: "completed", color: "#D25656" },
                { id: 1, goalTitle: "Đọc xong cuốn Amazon phát triển thần tốc.", status: "completed", color: "#123456" },
                { id: 1, goalTitle: "Dậy sớm lúc 5:30", status: "completed", color: "#5277FF" },
                { id: 1, goalTitle: "Get Link", status: "completed", color: "#3AD713" },
                { id: 1, goalTitle: "Đọc xong cuốn Amazon phát triển thần tốc.", status: "completed", color: "#123456" },
                { id: 1, goalTitle: "Dậy sớm lúc 5:30", status: "completed", color: "#123456" },
              ],
        }
